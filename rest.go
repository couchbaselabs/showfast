...
func getBenchmarks(c *gin.Context) {
	...
	sub_category := c.Param("sub_category")
	if sub_category == "all" {
		sub_category = ""
	}

	benchmarks, err := ds.getBenchmarks(component, category, sub_category)
	if err != nil {
		c.AbortWithError(500, err)
		return
	}
...
func getMetrics(c *gin.Context) {
	...
	metrics, err := ds.getMetrics(component, category, sub_category)
	if err != nil {
		c.AbortWithError(500, err)
		return
	}
...
func httpEngine() *gin.Engine {
	...
	rg.GET("benchmarks/:component/:category/:sub_category", getBenchmarks)
	...
	rg.GET("metrics/:component/:category/:sub_category", getMetrics)
